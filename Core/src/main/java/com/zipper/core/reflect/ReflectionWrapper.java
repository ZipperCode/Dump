...
public final class ReflectionWrapper {
    ...
    private ReflectionWrapper(Class<?> clazz) {
        this.clazz = clazz;
    }
    ...
    public static ReflectionWrapper on(String name) {
        return new ReflectionWrapper(findClass(name));
    }

    public static ReflectionWrapper on(String name, ClassLoader loader) {
        return new ReflectionWrapper(findClass(name, loader));
    }

    public static <T> ReflectionWrapper on(Class<T> clazz) {
        return new ReflectionWrapper(clazz);
    }
