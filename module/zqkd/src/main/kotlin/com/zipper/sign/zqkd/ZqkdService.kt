...
interface ZqkdService {
    ...
    // https://kd.youth.cn/WebApi/invite/openHourRed
    @FormUrlEncoded
    @POST
    suspend fun getTaskBrowse(
        @Url url: String ,
        @Field("cookie") cookie: String,
        @Field("cookie_id") cookie_id: String,
        @Field("uid") uid: String ,
        @Field("zqkey") zqkey: String,
        @Field("zqkey_id") zqkey_id: String,
        @Field("access") access: String = "WIFI",
        @Field("app-version") appVersion:String =  "3.7.10",
        @Field("app_version") appVersion1:String =  "3.7.10",
        @Field("channel")channel:String =  "c4015",
        @Field("device_brand")device_brand:String =  "Xiaomi",
        @Field("device_id")device_id:String =  "55860231",
        @Field("device_model")device_model:String =  "MI+6",
        @Field("device_platform")device_platform:String =  "android",
        @Field("device_type")device_type:String =  "android",
        @Field("mi")mi:String =  "0",
        @Field("os_api")os_api:String =  "30",
        @Field("request_time")request_time:String =  "1634122759",
        @Field("sm_device_id")sm_device_id:String =  "2021100220074244c1349baf562f85dc18972d74a0696f01c23b885ac4e4df",
    ...
    @FormUrlEncoded
    @POST
    suspend fun openHourRed(
        @Url url: String = "https://kd.youth.cn/WebApi/invite/openHourRed"
    ): BaseResponse<Box>
}