...
import com.zipper.plugin.dump.activity.TranslucentActivity
import com.zipper.plugin.dump.bean.ViewInfo
import com.zipper.plugin.dump.databinding.FragmentDumpBinding
import com.zipper.plugin.dump.service.DumpService
import com.zipper.plugin.dump.util.AccessibilityHelper
import com.zipper.plugin.dump.util.AppUtils
...
//            navController.navigate(R.id.action_dumpFragment_to_settingFragment)
    ...
    companion object{
        val TAG: String = DumpFragment::class.java.simpleName
    }
}